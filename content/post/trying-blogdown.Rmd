...
play with MSMs just a little bit:
...
corresponding to the treatment (A) and first baseline covariate are significant
(recall that these were the variables we used in specifying the SEM for Y).
