...
$$Y = I(A > 25) \cdot I(W_1 > 0),$$

for n = 100. We then project the observed data (O) onto a marginal structural
model (MSM) using a logistic regression with terms for all of the covariates and
