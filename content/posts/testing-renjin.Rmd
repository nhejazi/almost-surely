...
`r round(table[2, 3] / table[3, 3], 0)`__) when compared to the
bytecode-compiled version of our function. This was just a simple example, but
we were able to save so much computational time just by naively calling
